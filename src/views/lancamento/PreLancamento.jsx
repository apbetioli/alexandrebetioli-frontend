...
class PreLancamento extends React.Component {
  render() {
    let pl1_liberado = new Date() >= new Date("2020-06-01 08:00:00");
    let pl2_liberado = new Date() >= new Date("2020-06-07 08:00:00");
                    ...
                    <Col lg="9">
                      <p>
                        ...
                        <span className="legenda-video">
                          {pl1_liberado ? "LIBERADO" : "Estréia 05/06 às 8h"}
                        </span>
                      </p>
                    </Col>
                  </Row>
                  ...
                  <Row>
                    ...
                    <Col lg="9">
                      <p>
                        ...
                        <span className="legenda-video">
                          {pl2_liberado ? "LIBERADO" : "Estréia 07/06 às 8h"}
                        </span>
                      </p>
                    </Col>
                  </Row>
